        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="w-9 h-9 rounded-lg bg-slate-800 hover:bg-emerald-500 hover:text-slate-900 border border-slate-700 flex items-center justify-center text-slate-300 transition"
                title="Facebook"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="w-9 h-9 rounded-lg bg-emerald-950 hover:bg-emerald-500 hover:text-white border border-emerald-700/60 flex items-center justify-center text-emerald-400 transition"
                title="WhatsApp"
              >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/" className="hover:text-emerald-400 flex items-center gap-1.5 transition">
              ...
              <li>
                <Link href="/#intercity" className="hover:text-emerald-400 flex items-center gap-1.5 transition">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/captain/" prefetch={false} className="text-emerald-400 font-bold hover:underline flex items-center gap-1.5">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="tel:+923350455599" className="text-slate-200 hover:text-emerald-400 font-semibold">
                  +92 335 0455599
                </a>
              </div>
              <div className="flex items-center gap-2.5">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="mailto:olak.tbt@gmail.com" className="text-slate-300 hover:text-white">
                  olak.tbt@gmail.com
                </a>
              </div>
            </div>
